...
def main(quick: bool = False, master_out: Path = DATA_DIR / "master_report.json"):
    ...
    # 1 Electrochemistry
    print("\n[1/10] Electrochemistry (Pourbaix + kinetics)...")
    try:
    ...
    print("\n[8/12] Mechanical properties (Hall-Petch + ss + dispersion)...")
    try:
