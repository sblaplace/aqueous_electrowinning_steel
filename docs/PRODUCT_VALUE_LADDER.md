...
```json
{
  ...
  "mode": "full-grade",
  "source_hashes": {
    "models/product_ladder.py": "408db9edbaae45de",
    ...
    "models/anchors.py": "df009136da232bfe",
